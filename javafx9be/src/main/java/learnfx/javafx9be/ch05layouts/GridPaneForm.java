...
public class GridPaneForm extends Application {
    ...
    public void start(Stage stage) {
        ...
        initGridPane();
        FlowPane topBanner = initTopBanner();
    ...
    private void initGridPane() {
        ...
        addToGrid(firstNameLbl, 0, 0, HPos.RIGHT);
        addToGrid(lastNameLbl, 0, 1, HPos.RIGHT);
        addToGrid(firstNameFld, 1, 0, HPos.LEFT);
        addToGrid(lastNameFld, 1, 1, HPos.LEFT);
        addToGrid(saveButt, 1, 2, HPos.RIGHT);
    }

    private FlowPane initTopBanner() {
    ...
    private void addToGrid(Node node, int col, int row, HPos hPos) {
        GridPane.setHalignment(node, hPos);
        gridPane.add(node, col, row);
    }

    private SVGPath makeIcon() {
